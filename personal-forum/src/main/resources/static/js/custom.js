...
//$(function(){$(".entry-content img,img.lazy").lazyload({placeholder:bloghost+"zb_users/theme/quietlee/style/images/grey.gif",effect:"fadeIn",threshold:2,failurelimit:5})});
/* AJAX获取第二页内容 */
